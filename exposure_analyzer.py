...
def analyze_path(X, y, model=None,
                 # p_grid={},
                 feature_set=[], n_trials=100,
                 # n_trials_ms=10, save=False, output_path='',
                 # output_file='',
...
def statistical_assessment_with_confounder(sorted_paths, feature_idx_dict, paths_median_threshold,
                                           ...
                                           binary_outcome, y, visualize_dict, test_size,outcome_dir,fmap_fn,
                                            tree_counts, labels, X, possibleDirs, outcome_folder_name, file_prefix, outputDir, path
                                           ):
...
def runWorkflow(**kargs):
    ...
    p_val_df = statistical_assessment_with_confounder(sorted_paths, feature_idx_dict, paths_median_threshold,
                                           sign_pair, topk_profile_str, confounders_df,
                                           binary_outcome, y, visualize_dict, test_size,outcome_dir,fmap_fn,
                                            tree_counts, labels, X, possibleDirs, outcome_folder_name, file_prefix)
...
if __name__ == "__main__":
    ...
    plotDir = plot_predir
    # m_Dir = os.path.join(os.getcwd(), 'plot/{}/'.format(analyze_method))
